...
public class CommonPageObject {
    ...
    @FindBy(how = How.XPATH, using = "//div[@class='sc-11uohgb-1 buqxEg']/p")
    public WebElement orderpr1;
    @FindBy(how = How.XPATH, using = "//div[@class='sc-11uohgb-1 buqxEg']/p[2]")
    public WebElement orderpr2;
